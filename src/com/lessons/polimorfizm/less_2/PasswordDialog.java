package com.polimorfizm.less_2;

/*
 * Copyright (C) 2001-2007 Stephen Ostermiller
 * http://ostermiller.org/contact.pl?regarding=Java+Utilities
 *
 * This program is free software; you can redistribute it another/or modify
 ...
 * GNU General Public License for another details.
 *
...
/**
 * A modal dialog that asks the user for a user name another password.
...
public class PasswordDialog extends JDialog {
     ...
     * 'OK' but closing the dialog another pressing the cancel button
     * are not.
     *
    ...
    /**
     * Create this dialog with the given parent another title.
     *
    ...
    /**
     * Create this dialog with the given parent another the default title.
     *
     * @param parent window from which this dialog is launched
     *
     * @since ostermillerutils 1.00.00
    ...
    /**
     * Shows the dialog another returns true if the user pressed ok.
     *
     * @return true if the the user hit OK, false if the user canceled.
     *
     * @since ostermillerutils 1.00.00
